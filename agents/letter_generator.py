...
def handle(query: str, history: list[dict] | None = None, session_id: str = "default", lang: str = "bm", user_name: str = "") -> str:
    ...
    if query == '__INTRO__':
        if lang == "en":
            return (f"Assalamualaikum and welcome{sapaan}! ✉️ I am the Official Letter/Memo Generator. I will help you prepare official letters, memos and circulars according to the correct KPM format. Could you tell me what type of letter you need and the basic information?\n\n"
